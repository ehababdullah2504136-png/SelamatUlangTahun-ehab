...
new TypeIt("#teks1", {
  strings: ["اليوم، أرفع أفضل الدعوات لك.", "أتمنى أن تصبح الأشياء التي تثيرك مصدر قوتك وليس ضعفك.", "أتمنى أن يحميك العالم حيثما تذهب.", "أتمنى أن تكون أيامك مليئة بالحب الذي لا حدود له." , "أتمنى أن تتحقق كل أحلامك وتسهل كل خطواتك."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["معي أو بدوني، أتمنى أن يسعدك الكون بكل الطرق.", " ", "بارك الله في عمرك، شكراً لك على بقاؤك معي حتى الآن.", " ", "- تمنياتي الأفضل لك"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
